...
const ATTACK_RULES = {
    ...
    '읓': { tier: 5, name: '전설 (방어 불가)', desc: "'치읓' 등 한글 자모 명칭에 붙는 받침 단어로, '읓'으로 시작하는 단어는 존재하지 않습니다.", tag: '읓' },
...
const WORD_DATABASE = [
    ...
    { word: "암탉", startChar: "암", endChar: "탉", definition: "알을 낳을 수 있는 암컷 닭. '탉'으로 시작하는 단어가 전혀 없어 완벽한 피니셔 카드.", tier: 5 },
