...
var ATTACK_RULES = {
    ...
    '듐': { tier: 5, name: '전설 (방어 불가)', desc: "'듐'으로 시작하는 단어가 없습니다. 바나듐, 로듐, 인듐, 이리듐 등 다양합니다.", tag: '듐', defense: '듐바(Tuba의 오타/북한어 표기)' },
    ...
    '켓': { tier: 3, name: '희귀 (방어 까다로움)', desc: "'켓'으로 시작하는 단어로 사투리 외에 '켓(ket, 화학용어)' 등 극소수 전문용어만 있어 일반인 기준 한방입니다.", tag: '켓', defense: '켓(화학용어 ket), 켓밸브' },
